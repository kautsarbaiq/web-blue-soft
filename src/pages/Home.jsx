  ...
  return (
    <div className="w-full flex flex-col">
      <section id="home" className="relative flex items-center justify-center pt-[100px] pb-3xl overflow-hidden min-h-screen">
        ...
        <div className={`z-10 w-full relative flex flex-col justify-center min-h-screen ${theme === 'light' ? 'items-center text-center px-6' : 'items-end pr-6 md:pr-10'} -mt-20 pointer-events-none`}>
          ...
          {/* Description Text Box - Hidden in Light Mode to match minimal reference image, or kept at bottom */}
          <div className={`absolute bottom-10 ${theme === 'light' ? 'left-1/2 -translate-x-1/2 text-center' : 'right-6 md:right-10 lg:right-20 text-left'} max-w-[200px] md:max-w-[300px] pointer-events-none`}>
